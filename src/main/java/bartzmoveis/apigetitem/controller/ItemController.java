...
public class ItemController {
    ...
    // O Pageable é um objeto que contém informações sobre a página solicitada
    // (número, tamanho, ordenação),
    ...
    public ResponseEntity<?> findByCodeItem(@RequestParam("q") String code) {
        ...
        Optional<Item> erpOpt = service.findByCodeItem(code);
    ...
    public ResponseEntity<?> findByDescriptionItem(@RequestParam("q") String desc) {
        ...
        Optional<Item> erpOpt = service.findByDescriptionItem(desc);
    ...
    public ResponseEntity<List<Item>> searchByCode(@RequestParam("q") String query) {
        List<Item> results = service.searchByCode(query);
    ...
    public ResponseEntity<List<Item>> searchByDescription(@RequestParam("q") String query) {
        List<Item> results = service.searchByDescription(query);
